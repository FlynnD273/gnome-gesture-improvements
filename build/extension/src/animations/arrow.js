...
import * as Util from 'resource:///org/gnome/shell/extensions/extension.js';
...
export const ArrowIconAnimation = registerClass(class GIE_ArrowIcon extends St.Widget {
    constructor() {
        super();
    ...
    gestureBegin(icon_name, from_left) {
        ...
        this._arrow_icon.set_gicon(Gio.Icon.new_for_string(`${Extension.dir.get_uri()}/assets/${icon_name}`));
    }

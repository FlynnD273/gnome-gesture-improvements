...
function InsertIntoImportsPath() {
    var _a, _b;
    const dirname = (_b = Gio.file_new_for_path((_a = imports.system.programPath) !== null && _a !== void 0 ? _a : imports.system.programInvocationName).get_parent()) === null || _b === void 0 ? void 0 : _b.get_path();
    if (dirname) {
...
const ExampleApp = registerClass(class ExampleApp extends Adw.Application {
    vfunc_startup() {
        super.vfunc_startup();
